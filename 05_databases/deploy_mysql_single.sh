...
EOF
    ...
    _logger info "6. Inject the service unit file, manage using systemctl"
    local MYSQL_SERVICE_UNIT="/etc/systemd/system/mysqld.service"
    [[ -f $MYSQL_SERVICE_UNIT ]] && cp -v $MYSQL_SERVICE_UNIT $MYSQL_SERVICE_UNIT.bak
...
function start_service() {
    _logger info "7. Start and enable MySQL service, open the corresponding firewall ports"
